...
// ---------------------------
 const serverName = 'TGW Dedicated';
...
//----------------------------
  const windowsUsername = 'root';
  const dcsVersion = 'DCS.openbeta-iberia6'; // if youre in beta, it would be 'DCS.openbeta', etc
const statsPath = 'C:\\Users\\root\\Saved Games\\DCS.openbeta-iberia7\\Slmod\\SlmodStats.lua';
