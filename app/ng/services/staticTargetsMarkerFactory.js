(function() {
      angular.module("redIberia").factory("StaticTargetsMarkerFactory", function($rootScope, $q, $filter, $document, $http, $timeout) {

            var StaticTargetsMarkerFactory = {};


                        // sort out what airbases need thier markers updated,  or created
                        StaticTargetsMarkerFactory.sortMarkers = function(e, cb) {
                            console.log(e);
                              var tgts = e.tgts;
                              var misisonData = e.misisondata;

                              $rootScope.keyData.staticTargets = {
                              ...
                              angular.forEach(tgts, function(obj, i) {
                                  console.log(obj);
                                    ...
                                    promises.push(q.promise);
                                          ...
                                          console.log(mkrData);
                                          $rootScope.keyData.staticTargets.features.push(mkrData)



                                    // now print the airbase markers
                                    StaticTargetsMarkerFactory.printMarkers(function(cb) {
                                          q.resolve();
                                    })
                        ...
                        StaticTargetsMarkerFactory.printMarkers = function(cb) {
                              ...
                              $rootScope.keyData.staticTargetsMarkers.forEach((marker) => marker.remove());

                              var promises = [];

                              // create all new marker divs on the map.
                              angular.forEach($rootScope.keyData.staticTargets.features, function(obj) {
                                  ...
                                  console.log(obj);
                                    ...
                                    $rootScope.keyData.staticTargetsMarkers.push(newMKR)
            ...
            return StaticTargetsMarkerFactory;
